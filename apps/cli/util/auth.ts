import { idTokenSchema, tokenResponseSchema, type IdToken, type RS256Token, jwkSchema } from "@shared/util";
        ...
        const interval = setInterval(async () => {
          ...
          try {
            ...
            if (tokenResponse) {
              ...
              console.log(
                "Authenticated as " + (idToken.nickname ?? idToken.name ?? idToken.sub) + " (" + idToken.email + ")"
              );
              return resolve();
            }
          } catch (e) {
